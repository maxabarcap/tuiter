...
class TuitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tuit" do
    assert_difference("Tuit.count") do
      post tuits_url, params: { tuit: { description: @tuit.description, username: @tuit.username } }
    end
  ...
  test "should update tuit" do
    patch tuit_url(@tuit), params: { tuit: { description: @tuit.description, username: @tuit.username } }
